...
`,Qv=({scrollToEvent:e})=>{const t=C.useRef(null),n=C.useRef(null),[r,i]=C.useState(!1),[o,l]=C.useState(!1);C.useEffect(()=>{const c=()=>{l(window.innerWidth<1024)};return c(),window.addEventListener("resize",c),()=>window.removeEventListener("resize",c)},[]),C.useEffect(()=>{const c=setTimeout(()=>{t.current&&t.current.play()},1e3);return()=>clearTimeout(c)},[]),C.useEffect(()=>{const c=()=>{i(!1),n.current&&(n.current.pause(),n.current.currentTime=0)};return n.current&&(n.current.addEventListener("pause",c),n.current.addEventListener("ended",c)),()=>{n.current&&(n.current.removeEventListener("pause",c),n.current.removeEventListener("ended",c))}},[o]);const s=()=>{if(o){if(n.current){const c=n.current;c.pause(),c.currentTime=0;const m=c.play();m!==void 0&&m.then(()=>{c.requestFullscreen().catch(h=>{console.log("Error attempting to enable full-screen mode:",h)})}).catch(h=>{console.log("Failed to play the video automatically:",h)})}}else i(!0)},u=()=>{i(!1),t.current&&(t.current.pause(),t.current.currentTime=0)};return C.useEffect(()=>{const c=()=>{document.fullscreenElement||n.current&&(n.current.pause(),n.current.currentTime=0)};return document.addEventListener("fullscreenchange",c),()=>{document.removeEventListener("fullscreenchange",c)}},[]),a.jsxs(Fv,{children:[a.jsx(Mv,{ref:t,src:jc,loop:!0,muted:!0,playsInline:!0,alt:"Background video"}),a.jsx(Dv,{}),a.jsxs(Wv,{children:[a.jsx(Gv,{children:a.jsx(Vv,{src:Rv,alt:"LipusPlus logo"})}),a.jsx("h4",{children:"Meet the Physio of Hammarby Handball"}),a.jsx("p",{children:"Brand film highlighting LipusPlus's partnership with Hammarby Handball, showcasing through testimonals the effectiveness of the modality."}),a.jsxs(Uv,{children:[a.jsx(Ev,{onClick:s}),a.jsx(Bv,{onClick:e})]})]}),a.jsx(bv,{isOpen:r,onClose:u,children:a.jsx("video",{controls:!0,autoPlay:!0,children:a.jsx("source",{src:jc,type:"video/mp4"})})}),a.jsx("video",{ref:n,style:{display:"none"},src:Sv,type:"video/mp4",controls:!0})]})},gf="/portfolio/assets/lipusPlusLogo-022851c3.avif",vf="/portfolio/assets/lipusHeroImg-44921e74.avif",Yv=A.div`
  width: 200px;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
