...
`,Lg=A.div`
  margin-top: auto;
`;function Fg(e){const t=j.useRef(null);return j.useEffect(()=>{const n=setTimeout(()=>{t.current&&t.current.play()},4e3);return()=>clearTimeout(n)},[]),a.jsxs(Tg,{children:[a.jsx(zg,{ref:t,src:mg,loop:!0,muted:!0,playsInline:!0,alt:"A showreel showing clips from different productions."}),a.jsx(Rg,{children:a.jsxs(Og,{children:[a.jsx("h3",{children:"Cinematographer"}),a.jsx("p",{children:"Member of fsf Föreningen Severiges Filmfotografer (The Association of Swedish Film Cinematographers). Working in Narrative, Commercials, Music Videos and Still Photography."}),a.jsx(Lg,{children:a.jsx(Bg,{})})]})})]})}const Mg="/portfolio/assets/conceptReel-4e8f05ad.mp4",Dg=A.div`
  position: relative;
  display: flex;
  flex-direction: column;
  align-items: center;
