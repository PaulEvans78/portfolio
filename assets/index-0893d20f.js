...
`,Ut=m.img`
  width: 50%;
  height: auto;
  animation: ${ex} 3s ease-in-out infinite;
...
`,ox=m.div`
  margin-top: auto;
`,lx=()=>a.jsxs(tx,{children:[a.jsx(nx,{children:a.jsxs(ix,{children:[a.jsx(Ut,{src:Hv,alt:"React Logo."}),a.jsx(Ut,{src:$v,alt:"Webflow Logo."}),a.jsx(Ut,{src:Xv,alt:"Figma Logo."}),a.jsx(Ut,{src:_v,alt:"GitHub Logo."}),a.jsx(Ut,{src:Kv,alt:"HTML Logo."}),a.jsx(Ut,{src:Zv,alt:"CSS Logo."}),a.jsx(Ut,{src:qv,alt:"Javascript Logo."}),a.jsx(Ut,{src:Jv,alt:"Photoshop Logo."})]})}),a.jsxs(rx,{children:[a.jsx("h3",{children:"Frontend Tools"}),a.jsx("p",{children:"On top of all this I ma a qualified Frontend developer with a solid understanding of HTML, CSS, JavaScript, and React."}),a.jsx(ox,{children:a.jsx(Uv,{})})]})]}),ax="/portfolio/assets/lipusplus_brand_film_hammarby-2024_short-0c3de834.mp4",bc="/portfolio/assets/lipusplus_brand_film_hammarby-2024-c0930dc4.mp4",sx=m.div`
  width: 200px;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`,dx=({onClick:e})=>a.jsxs(sx,{children:[a.jsx(ux,{children:a.jsx(jf,{onClick:e,size:70})}),a.jsx(cx,{children:"Play Film"})]}),px=m.div`
  width: 200px;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`,mx=({onClick:e})=>a.jsxs(px,{children:[a.jsx(fx,{children:a.jsx(hr,{to:"/lipusplus",children:a.jsx(Pt,{onClick:e,size:70})})}),a.jsx(hx,{children:"See Case Study"})]}),Ax="/portfolio/assets/lipusPlusLogoWhite-b2e2b769.avif";function Cf(e){return An({tag:"svg",attr:{viewBox:"0 0 15 15",fill:"none"},child:[{tag:"path",attr:{fillRule:"evenodd",clipRule:"evenodd",d:"M12.8536 2.85355C13.0488 2.65829 13.0488 2.34171 12.8536 2.14645C12.6583 1.95118 12.3417 1.95118 12.1464 2.14645L7.5 6.79289L2.85355 2.14645C2.65829 1.95118 2.34171 1.95118 2.14645 2.14645C1.95118 2.34171 1.95118 2.65829 2.14645 2.85355L6.79289 7.5L2.14645 12.1464C1.95118 12.3417 1.95118 12.6583 2.14645 12.8536C2.34171 13.0488 2.65829 13.0488 2.85355 12.8536L7.5 8.20711L12.1464 12.8536C12.3417 13.0488 12.6583 13.0488 12.8536 12.8536C13.0488 12.6583 13.0488 12.3417 12.8536 12.1464L8.20711 7.5L12.8536 2.85355Z",fill:"currentColor"},child:[]}]})(e)}const gx=Vt`
  from {
    opacity: 0;
  }
  to {
...
`,yx=m.button`
  ...
  cursor: pointer;
  z-index: 100;
`,wx=({isOpen:e,onClose:t,children:n})=>e?a.jsx(vx,{children:a.jsxs(xx,{children:[a.jsx(yx,{onClick:t,children:a.jsx(Cf,{})}),n]})}):null,Sx=m.section`
  position: relative;
  max-width: 100%;
  min-width: 100%;
  overflow-x: hidden;
...
`,Bx=({scrollToEvent:e})=>{const t=j.useRef(null),n=j.useRef(null),[r,i]=j.useState(!1),[o,l]=j.useState(!1);j.useEffect(()=>{const c=()=>{l(window.innerWidth<1024)};return c(),window.addEventListener("resize",c),()=>window.removeEventListener("resize",c)},[]),j.useEffect(()=>{const c=setTimeout(()=>{t.current&&t.current.play()},1e3);return()=>clearTimeout(c)},[]);const s=()=>{o?setTimeout(()=>{if(n.current){const c=n.current;c.pause(),c.currentTime=0;const A=c.play();A!==void 0&&A.then(()=>{c.requestFullscreen().catch(p=>{console.log("Error attempting to enable full-screen mode:",p)})}).catch(p=>{console.log("Failed to play the video automatically:",p)})}},0):i(!0)},u=()=>{i(!1),t.current&&t.current.play()};return j.useEffect(()=>{const c=()=>{document.fullscreenElement||n.current&&(n.current.pause(),n.current.currentTime=0)};return document.addEventListener("fullscreenchange",c),()=>{document.removeEventListener("fullscreenchange",c)}},[]),a.jsxs(Sx,{children:[a.jsx(jx,{ref:t,src:ax,loop:!0,muted:!0,playsInline:!0,preload:"auto",alt:"Background video"}),a.jsx(Cx,{}),a.jsxs(kx,{children:[a.jsx(Ex,{children:a.jsx(Ix,{src:Ax,alt:"LipusPlus logo"})}),a.jsx("h4",{children:"Meet the Physio of Hammarby Handball"}),a.jsx("p",{children:"Brand film highlighting LipusPlus's partnership with Hammarby Handball. Together with LipusPlus we created a landing page using captivating content and testimonials to showcase the partnership and to invite users to a webinar providing evidence of the effectiveness of the modality."}),a.jsxs(Px,{children:[a.jsx(dx,{onClick:s}),a.jsx(mx,{onClick:e})]})]}),a.jsx(wx,{isOpen:r,onClose:u,children:a.jsx("video",{controls:!0,autoPlay:!0,preload:"auto",children:a.jsx("source",{src:bc,type:"video/mp4"})})}),a.jsx("video",{ref:n,style:{display:"none"},src:bc,type:"video/mp4",controls:!0,preload:"auto"})]})},kf="/portfolio/assets/lipusPlusLogo-022851c3.avif",Ef="/portfolio/assets/lipusHeroImg-44921e74.avif",bx=m.div`
  width: 200px;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`,Rx=({onClick:e})=>a.jsxs(bx,{children:[a.jsx(Nx,{children:a.jsx(hr,{to:"/lipusplus",children:a.jsx(Pt,{onClick:e,size:70})})}),a.jsx(Tx,{children:"See Case Study"})]}),zx=Vt`
  0% {
    transform: translateX(100%);
    opacity: 0;
  }
...
`,Gx=m.img`
  ...
  ${({isInView:e})=>e&&mn`
      animation: ${zx} 1s ease-out forwards;
    `}
`,If=()=>{const e=j.useRef(null),[t,n]=j.useState(!1);return j.useEffect(()=>{const r=new IntersectionObserver(i=>{i[0].isIntersecting&&n(!0)},{threshold:.1});return e.current&&r.observe(e.current),()=>{e.current&&r.unobserve(e.current)}},[]),a.jsxs(Ox,{children:[a.jsxs(Lx,{children:[a.jsx("h4",{children:"UX Case study"}),a.jsx(Mx,{children:a.jsx(Fx,{src:kf,alt:"The logo for LipuspLus"})}),a.jsx("p",{children:"LipusPlus aims to attract physiotherapists and elite athletes to its webinars on the Return to Play concept. An enticing and informative landing page is needed to generate leads for these webinars."}),a.jsx(Rx,{})]}),a.jsxs(Dx,{children:[a.jsx(Wx,{children:"Photo by Peder Rotkirch."}),a.jsx(Gx,{ref:e,src:Ef,alt:"A hammarby handball player in green and white stripes holds a ball.",isInView:t})]})]})},Vx="/portfolio/assets/vikings-23b289a3.mp4",Nc="/portfolio/assets/vikingsTrailer-3785bb88.mp4",Qx="/portfolio/assets/viaplayLogo-c60ae164.avif",Yx=m.div`
  width: 300px;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`,$x=({onClick:e})=>a.jsxs(Yx,{children:[a.jsx(Ux,{children:a.jsx("a",{href:"https://paulevans-dop.com/",target:"_blank",rel:"noopener noreferrer",children:a.jsx(Pt,{onClick:e,size:70})})}),a.jsx(Hx,{children:"Go to Cinematography Site"})]}),Xx=m.div`
  width: 200px;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`,Zx=({onClick:e})=>a.jsxs(Xx,{children:[a.jsx(_x,{children:a.jsx(jf,{onClick:e,size:70})}),a.jsx(Kx,{children:"Play Trailer"})]}),qx=Vt`
  from {
    opacity: 0;
  }
  to {
...
`,t1=m.button`
  ...
  cursor: pointer;
  z-index: 100;
`,n1=({isOpen:e,onClose:t,children:n})=>e?a.jsx(Jx,{children:a.jsxs(e1,{children:[a.jsx(t1,{onClick:t,children:a.jsx(Cf,{})}),n]})}):null,r1=m.section`
  position: relative;
  max-width: 100%;
  min-width: 100%;
  overflow-x: hidden;
...
`,f1=({onClick:e})=>a.jsxs(c1,{children:[a.jsx(d1,{children:a.jsx(hr,{to:"/ebie",children:a.jsx(Pt,{onClick:e,size:70})})}),a.jsx(p1,{children:"See Case Study"})]}),h1=Vt`
  0% {
    transform: translateX(100%);
    opacity: 0;
  }
...
`,bf=()=>{const e=j.useRef(null),[t,n]=j.useState(!1);return j.useEffect(()=>{const r=new IntersectionObserver(i=>{i[0].isIntersecting&&n(!0)},{threshold:.1});return e.current&&r.observe(e.current),()=>{e.current&&r.unobserve(e.current)}},[]),a.jsxs(m1,{children:[a.jsxs(A1,{children:[a.jsx("h4",{children:"UX Case study"}),a.jsx(g1,{children:a.jsx(v1,{src:Pf,alt:"The logo for Ebie"})}),a.jsx("p",{children:"Create and implement a completely new and user-friendly function within the platform that makes it easy for property owners to apply for and manage group insurance. Simplify the application and the overview for insurance status."}),a.jsx(f1,{})]}),a.jsxs(y1,{children:[a.jsx(x1,{children:"Photo from www.Ebie.se"}),a.jsx(w1,{ref:e,src:Bf,alt:"A street view on the corner of Sveavägen, Sergelstorg.",isInView:t})]})]})},S1="/portfolio/assets/hidden-7e893598.avif",j1="/portfolio/assets/hiddenMobileImg-1a91cc10.avif",C1="/portfolio/assets/BESTSHORTFILMSPECIALAWARD-EasternEuropeFilmFestival-December2022-489d2b56.avif",k1=m.section`
  position: relative;
  max-width: 100%;
  min-width: 100%;
  overflow-x: hidden;
...
`,R1=({scrollToEvent:e})=>a.jsxs(k1,{children:[a.jsx(N1,{children:a.jsx(T1,{children:"Photography by Nisse Virgin."})}),a.jsx(E1,{src:S1,alt:"A short film poster. A Man sits with his back to camera contemplating"}),a.jsx(I1,{src:j1,alt:"A short film poster. A Man sits with his back to camera contemplating"}),a.jsxs(P1,{children:[a.jsx("h4",{children:"Storytelling"}),a.jsx("p",{children:"Storytelling is at the heart of everything I do because it’s how I connect with people and make experiences meaningful. I’ve applied my narrative skills to develop commercials, content, films, and TV shows, while also shaping engaging user journeys and creating immersive experiences. I’ve been commissioned to write concepts for B2C clients, TV channels, and streaming services, with several of these concepts being optioned."}),a.jsx("p",{}),a.jsx("p",{children:"HIDDEN is a short film that I directed, produced, and wrote. It went on to win the Special Award for Best Short Film at the Eastern European Short Film Festival."}),a.jsx(B1,{children:a.jsx(b1,{src:C1,alt:"A wreath for Winner Eastern European Short Film Festival "})})]})]}),Nf=Vt`
  from {
    opacity: 0;
  }
  to {
...
`,z1=m.div`
  ...
  ${({isVisible:e})=>e&&mn`
    ...
    `}
`,Wl=(e=.1)=>{const[t,n]=j.useState(!1),r=j.useRef(null);return j.useEffect(()=>{const i=new IntersectionObserver(([o])=>{o.isIntersecting&&(n(!0),i.unobserve(o.target))},{threshold:e});return r.current&&i.observe(r.current),()=>{r.current&&i.unobserve(r.current)}},[e]),[r,t]},O1=m.section`
  max-width: 100vw;
  min-width: 100vw;
  display: flex;
  flex-direction: column;
...
`,L1=()=>{const[e,t]=Wl(),[n,r]=Wl(),[i,o]=Wl(),l=j.useRef(null),s=()=>{l.current&&l.current.scrollIntoView({behavior:"smooth"})};return a.jsxs(O1,{children:[a.jsx(C0,{}),a.jsxs(Tc,{ref:e,isVisible:t,children:[a.jsx(Gv,{}),a.jsx($0,{})]}),a.jsx(Bv,{}),a.jsxs(Tc,{ref:n,isVisible:r,children:[a.jsx(ov,{}),a.jsx(gv,{})]}),a.jsx(Bx,{scrollToEvent:s}),a.jsx("div",{ref:l}),a.jsx(If,{}),a.jsx(u1,{}),a.jsx(bf,{}),a.jsx(z1,{ref:i,isVisible:o,children:a.jsx(R1,{})}),a.jsx(lx,{})]})},M1=m.section`
  max-width: 100vw;
  min-width: 100vw;
  display: flex;
  flex-direction: column;
  ...
  align-content: center;
  margin-top: 170px;
`,F1=()=>(j.useRef(null),a.jsxs(M1,{children:[a.jsx(If,{}),a.jsx(bf,{})]})),W1="/portfolio/assets/meAbout-b0dd0af4.avif",D1=Vt`
  0% {
    transform: translateX(-100%);
    opacity: 0;
  }
...
`,Z1=m.img`
  ...
  ${({isInView:e})=>e&&mn`
      visibility: visible;
      animation: ${$1} 1s ease-out forwards;
    `}
`,q1=()=>{const e=j.useRef(null),[t,n]=j.useState(!1);return j.useEffect(()=>{const r=new IntersectionObserver(i=>{i[0].isIntersecting&&n(!0)},{threshold:.1});return e.current&&r.observe(e.current),()=>{e.current&&r.unobserve(e.current)}},[]),a.jsxs(X1,{children:[a.jsxs(_1,{children:[a.jsx("h3",{children:"For fun"}),a.jsx("p",{children:"Surfing and traveling are my two biggest passions. When I'm not paddling out into the sea I like to work out at the gym or swim in the lake. I also cherish the time I spend with my family, friends cooking and watching movies and TV shows."})]}),a.jsx(K1,{children:a.jsx(Z1,{ref:e,src:H1,alt:"A surfboard propped up against a mobile home",isInView:t})})]})},J1=m.section`
  max-width: 100vw;
  min-width: 100vw;
  display: flex;
  flex-direction: column;
...
`,Pw=m.div`
  ...
  justify-items: center;
  justify-content: space-evenly;
`,Bw=()=>{const e=j.useRef(null);return a.jsxs(r0,{children:[a.jsx(Ew,{}),a.jsxs(Iw,{children:[a.jsx(g0,{footerRef:e}),a.jsxs(Pw,{children:[a.jsxs(Kg,{children:[a.jsx(On,{path:"/",element:a.jsx(L1,{})}),a.jsx(On,{path:"/casestudies",element:a.jsx(F1,{})}),a.jsx(On,{path:"/about",element:a.jsx(ey,{})}),a.jsx(On,{path:"/lipusplus",element:a.jsx(My,{})}),a.jsx(On,{path:"/ebie",element:a.jsx(cw,{})})]}),a.jsx(Cw,{ref:e})]}),a.jsx(fw,{})]})]})};Dl.createRoot(document.getElementById("root")).render(a.jsx(ge.StrictMode,{children:a.jsx(Bw,{})}));
