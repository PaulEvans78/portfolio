...
`,by=pe.forwardRef((e,t)=>p.jsxs(Vy,{ref:t,children:[p.jsx(Xy,{children:p.jsx(Zs,{to:"/",children:p.jsx(Ky,{src:Va,autoPlay:!0,loop:!0,muted:!0,playsInline:!0,alt:"A revolving logo showing the initals PE and a cartton version of Paul Evans.."})})}),p.jsx(Zy,{}),p.jsxs(By,{children:[p.jsx(zc,{children:"Copyright 2024."}),p.jsx(zc,{children:"Paul Evans."}),p.jsx(Wy,{children:p.jsx("a",{href:"mailto:paul@paulevans.se",children:"paul@paulevans.se"})}),p.jsx(Hy,{children:p.jsx("a",{href:"tel:+46739908858",children:"+46739908858"})})]})]})),Zy=()=>p.jsx(Qy,{children:p.jsx(Wa.Provider,{value:{size:"2em"},children:Uy.map(e=>p.jsxs(Yy,{href:e.href,target:e.target,rel:e.rel,children:[e.icon,p.jsx(Gy,{children:e.des})]},e.id))})}),Jy=()=>{const{pathname:e}=Jn();return E.useEffect(()=>{window.scrollTo(0,0)},[e]),null},qy=S.div`
  min-height: 100%;
  max-width: 100vw;
`,ex=S.div`
  max-width: 100vw;
