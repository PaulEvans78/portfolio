 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(I,M){var F=I.length;I.push(M);e:for(;0<F;){var X=F-1>>>1,P=I[X];if(0<i(P,M))I[X]=M,I[F]=P,F=X;else break e}}function n(I){return I.length===0?null:I[0]}function r(I){if(I.length===0)return null;var M=I[0],F=I.pop();if(F!==M){I[0]=F;e:for(var X=0,P=I.length,R=P>>>1;X<R;){var L=2*(X+1)-1,D=I[L],y=L+1,U=I[y];if(0>i(D,F))y<P&&0>i(U,D)?(I[X]=U,I[y]=F,X=y):(I[X]=D,I[L]=F,X=L);else if(y<P&&0>i(U,F))I[X]=U,I[y]=F,X=y;else break e}}return M}function i(I,M){var F=I.sortIndex-M.sortIndex;return F!==0?F:I.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,s=l.now();e.unstable_now=function(){return l.now()-s}}var u=[],c=[],m=1,h=null,A=3,S=!1,w=!1,v=!1,k=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(I){for(var M=n(c);M!==null;){if(M.callback===null)r(c);else if(M.startTime<=I)r(c),M.sortIndex=M.expirationTime,t(u,M);else break;M=n(c)}}function x(I){if(v=!1,p(I),!w)if(n(u)!==null)w=!0,rt(C);else{var M=n(c);M!==null&&Se(x,M.startTime-I)}}function C(I,M){w=!1,v&&(v=!1,f(T),T=-1),S=!0;var F=A;try{for(p(M),h=n(u);h!==null&&(!(h.expirationTime>M)||I&&!he());){var X=h.callback;if(typeof X=="function"){h.callback=null,A=h.priorityLevel;var P=X(h.expirationTime<=M);M=e.unstable_now(),typeof P=="function"?h.callback=P:h===n(u)&&r(u),p(M)}else r(u);h=n(u)}if(h!==null)var R=!0;else{var L=n(c);L!==null&&Se(x,L.startTime-M),R=!1}return R}finally{h=null,A=F,S=!1}}var B=!1,O=null,T=-1,Q=5,b=-1;function he(){return!(e.unstable_now()-b<Q)}function de(){if(O!==null){var I=e.unstable_now();b=I;var M=!0;try{M=O(!0,I)}finally{M?ge():(B=!1,O=null)}}else B=!1}var ge;if(typeof d=="function")ge=function(){d(de)};else if(typeof MessageChannel<"u"){var De=new MessageChannel,we=De.port2;De.port1.onmessage=de,ge=function(){we.postMessage(null)}}else ge=function(){k(de,0)};function rt(I){O=I,B||(B=!0,ge())}function Se(I,M){T=k(function(){I(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(I){I.callback=null},e.unstable_continueExecution=function(){w||S||(w=!0,rt(C))},e.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Q=0<I?Math.floor(1e3/I):5},e.unstable_getCurrentPriorityLevel=function(){return A},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function(I){switch(A){case 1:case 2:case 3:var M=3;break;default:M=A}var F=A;A=M;try{return I()}finally{A=F}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(I,M){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var F=A;A=I;try{return M()}finally{A=F}},e.unstable_scheduleCallback=function(I,M,F){var X=e.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?X+F:X):F=X,I){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=F+P,I={id:m++,callback:M,priorityLevel:I,startTime:F,expirationTime:P,sortIndex:-1},F>X?(I.sortIndex=F,t(c,I),n(u)===null&&I===n(c)&&(v?(f(T),T=-1):v=!0,Se(x,F-X))):(I.sortIndex=P,t(u,I),w||S||(w=!0,rt(C))),I},e.unstable_shouldYield=he,e.unstable_wrapCallback=function(I){var M=A;return function(){var F=A;A=M;try{return I.apply(this,arguments)}finally{A=F}}}})(pd);fd.exports=pd;var mh=fd.exports;/**
 * @license React
...
`,Hg=()=>a.jsx(Yg,{children:a.jsx(An,{to:"/casestudies",children:a.jsxs(Vg,{children:[a.jsx(Qg,{src:Gg,alt:"Mobile prototype frames."}),a.jsx(Ug,{children:a.jsxs(is,{children:[a.jsx("h2",{children:"UX Case Studies"}),a.jsx(Ro,{children:"As a UX/UI designer with storytelling expertise, I create engaging, user-focused experiences that enhance usability and elevate brand impact."}),a.jsx($g,{children:a.jsx(Ro,{children:"See case studies .."})})]})})]})})}),Qc="/portfolio/assets/AIReel-9fb26f3d.mp4",Xg=e=>{const t=document.createElement("video");t.src=e,t.preload="auto",t.load()},_g=g.div`
  grid-area: ai;
  display: flex;
  align-self: flex-end;
  width: 100%;
...
`,Zv=()=>{const[e,t]=Lo(),[n,r]=Lo(),i=j.useRef(null),[o]=wg();return j.useEffect(()=>{o.get("target")==="AICaseStudyBreaking"&&i.current&&i.current.scrollIntoView({behavior:"smooth"})},[o]),a.jsxs(Kv,{children:[a.jsxs(Xc,{ref:e,isVisible:t,children:[a.jsx(Pv,{}),a.jsx(zv,{})]}),a.jsxs(Xc,{ref:n,isVisible:r,children:[a.jsx(_v,{ref:i}),a.jsx(Yv,{})]})]})},qv="/portfolio/assets/meAbout-b0dd0af4.avif",Jv=Qt`
  0% {
    transform: translateX(-100%);
    opacity: 0;
  }
...
`,Ry=({onClick:e})=>a.jsxs(Iy,{children:[a.jsx(Py,{children:a.jsx("a",{href:"https://www.lipusplus.com/casestudies/hammarby",target:"_blank",rel:"noopener noreferrer",children:a.jsx(Vp,{onClick:e,size:60})})}),a.jsx(Ny,{children:"LipusPlus.com"})]}),By=g.section`
  max-width: 93.5%;
  display: grid;
  grid-template-columns: 32% 32% 32%;
  grid-template-rows: auto;
