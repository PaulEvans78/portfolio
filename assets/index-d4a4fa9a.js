 ...
 *
 * @license MIT
 */function ii(){return ii=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},ii.apply(this,arguments)}var Zt;(function(e){e.Pop="POP",e.Push="PUSH",e.Replace="REPLACE"})(Zt||(Zt={}));const mc="popstate";function n0(e){e===void 0&&(e={});function t(i,o){let{pathname:l="/",search:s="",hash:u=""}=Rn(i.location.hash.substr(1));return!l.startsWith("/")&&!l.startsWith(".")&&(l="/"+l),Fa("",{pathname:l,search:s,hash:u},o.state&&o.state.usr||null,o.state&&o.state.key||"default")}function n(i,o){let l=i.document.querySelector("base"),s="";if(l&&l.getAttribute("href")){let u=i.location.href,c=u.indexOf("#");s=c===-1?u:u.slice(0,c)}return s+"#"+(typeof o=="string"?o:yo(o))}function r(i,o){$s(i.pathname.charAt(0)==="/","relative pathnames are not supported in hash history.push("+JSON.stringify(o)+")")}return i0(t,n,r,e)}function he(e,t){if(e===!1||e===null||typeof e>"u")throw new Error(t)}function $s(e,t){if(!e){typeof console<"u"&&console.warn(t);try{throw new Error(t)}catch{}}}function r0(){return Math.random().toString(36).substr(2,8)}function Ac(e,t){return{usr:e.state,key:e.key,idx:t}}function Fa(e,t,n,r){return n===void 0&&(n=null),ii({pathname:typeof e=="string"?e:e.pathname,search:"",hash:""},typeof t=="string"?Rn(t):t,{state:n,key:t&&t.key||r||r0()})}function yo(e){let{pathname:t="/",search:n="",hash:r=""}=e;return n&&n!=="?"&&(t+=n.charAt(0)==="?"?n:"?"+n),r&&r!=="#"&&(t+=r.charAt(0)==="#"?r:"#"+r),t}function Rn(e){let t={};if(e){let n=e.indexOf("#");n>=0&&(t.hash=e.substr(n),e=e.substr(0,n));let r=e.indexOf("?");r>=0&&(t.search=e.substr(r),e=e.substr(0,r)),e&&(t.pathname=e)}return t}function i0(e,t,n,r){r===void 0&&(r={});let{window:i=document.defaultView,v5Compat:o=!1}=r,l=i.history,s=Zt.Pop,u=null,c=m();c==null&&(c=0,l.replaceState(ii({},l.state,{idx:c}),""));function m(){return(l.state||{idx:null}).idx}function p(){s=Zt.Pop;let C=m(),f=C==null?null:C-c;c=C,u&&u({action:s,location:v.location,delta:f})}function g(C,f){s=Zt.Push;let d=Fa(v.location,C,f);n&&n(d,C),c=m()+1;let h=Ac(d,c),y=v.createHref(d);try{l.pushState(h,"",y)}catch(k){if(k instanceof DOMException&&k.name==="DataCloneError")throw k;i.location.assign(y)}o&&u&&u({action:s,location:v.location,delta:1})}function S(C,f){s=Zt.Replace;let d=Fa(v.location,C,f);n&&n(d,C),c=m();let h=Ac(d,c),y=v.createHref(d);l.replaceState(h,"",y),o&&u&&u({action:s,location:v.location,delta:0})}function w(C){let f=i.location.origin!=="null"?i.location.origin:i.location.href,d=typeof C=="string"?C:yo(C);return d=d.replace(/ $/,"%20"),he(f,"No window.location.(origin|href) available to create URL for href: "+d),new URL(d,f)}let v={get action(){return s},get location(){return e(i,l)},listen(C){if(u)throw new Error("A history only accepts one active listener");return i.addEventListener(mc,p),u=C,()=>{i.removeEventListener(mc,p),u=null}},createHref(C){return t(i,C)},createURL:w,encodeLocation(C){let f=w(C);return{pathname:f.pathname,search:f.search,hash:f.hash}},push:g,replace:S,go(C){return l.go(C)}};return v}var gc;(function(e){e.data="data",e.deferred="deferred",e.redirect="redirect",e.error="error"})(gc||(gc={}));function o0(e,t,n){n===void 0&&(n="/");let r=typeof t=="string"?Rn(t):t,i=Hs(r.pathname||"/",n);if(i==null)return null;let o=lf(e);l0(o);let l=null;for(let s=0;l==null&&s<o.length;++s){let u=v0(i);l=m0(o[s],u)}return l}function lf(e,t,n,r){t===void 0&&(t=[]),n===void 0&&(n=[]),r===void 0&&(r="");let i=(o,l,s)=>{let u={relativePath:s===void 0?o.path||"":s,caseSensitive:o.caseSensitive===!0,childrenIndex:l,route:o};u.relativePath.startsWith("/")&&(he(u.relativePath.startsWith(r),'Absolute route path "'+u.relativePath+'" nested under path '+('"'+r+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),u.relativePath=u.relativePath.slice(r.length));let c=sn([r,u.relativePath]),m=n.concat(u);o.children&&o.children.length>0&&(he(o.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+c+'".')),lf(o.children,t,m,c)),!(o.path==null&&!o.index)&&t.push({path:c,score:f0(c,o.index),routesMeta:m})};return e.forEach((o,l)=>{var s;if(o.path===""||!((s=o.path)!=null&&s.includes("?")))i(o,l);else for(let u of af(o.path))i(o,l,u)}),t}function af(e){let t=e.split("/");if(t.length===0)return[];let[n,...r]=t,i=n.endsWith("?"),o=n.replace(/\?$/,"");if(r.length===0)return i?[o,""]:[o];let l=af(r.join("/")),s=[];return s.push(...l.map(u=>u===""?o:[o,u].join("/"))),i&&s.push(...l),s.map(u=>e.startsWith("/")&&u===""?"/":u)}function l0(e){e.sort((t,n)=>t.score!==n.score?n.score-t.score:h0(t.routesMeta.map(r=>r.childrenIndex),n.routesMeta.map(r=>r.childrenIndex)))}const a0=/^:[\w-]+$/,s0=3,u0=2,c0=1,d0=10,p0=-2,vc=e=>e==="*";function f0(e,t){let n=e.split("/"),r=n.length;return n.some(vc)&&(r+=p0),t&&(r+=u0),n.filter(i=>!vc(i)).reduce((i,o)=>i+(a0.test(o)?s0:o===""?c0:d0),r)}function h0(e,t){return e.length===t.length&&e.slice(0,-1).every((r,i)=>r===t[i])?e[e.length-1]-t[t.length-1]:0}function m0(e,t){let{routesMeta:n}=e,r={},i="/",o=[];for(let l=0;l<n.length;++l){let s=n[l],u=l===n.length-1,c=i==="/"?t:t.slice(i.length)||"/",m=A0({path:s.relativePath,caseSensitive:s.caseSensitive,end:u},c);if(!m)return null;Object.assign(r,m.params);let p=s.route;o.push({params:r,pathname:sn([i,m.pathname]),pathnameBase:S0(sn([i,m.pathnameBase])),route:p}),m.pathnameBase!=="/"&&(i=sn([i,m.pathnameBase]))}return o}function A0(e,t){typeof e=="string"&&(e={path:e,caseSensitive:!1,end:!0});let[n,r]=g0(e.path,e.caseSensitive,e.end),i=t.match(n);if(!i)return null;let o=i[0],l=o.replace(/(.)\/+$/,"$1"),s=i.slice(1);return{params:r.reduce((c,m,p)=>{let{paramName:g,isOptional:S}=m;if(g==="*"){let v=s[p]||"";l=o.slice(0,o.length-v.length).replace(/(.)\/+$/,"$1")}const w=s[p];return S&&!w?c[g]=void 0:c[g]=(w||"").replace(/%2F/g,"/"),c},{}),pathname:o,pathnameBase:l,pattern:e}}function g0(e,t,n){t===void 0&&(t=!1),n===void 0&&(n=!0),$s(e==="*"||!e.endsWith("*")||e.endsWith("/*"),'Route path "'+e+'" will be treated as if it were '+('"'+e.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+e.replace(/\*$/,"/*")+'".'));let r=[],i="^"+e.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(l,s,u)=>(r.push({paramName:s,isOptional:u!=null}),u?"/?([^\\/]+)?":"/([^\\/]+)"));return e.endsWith("*")?(r.push({paramName:"*"}),i+=e==="*"||e==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):n?i+="\\/*$":e!==""&&e!=="/"&&(i+="(?:(?=\\/|$))"),[new RegExp(i,t?void 0:"i"),r]}function v0(e){try{return e.split("/").map(t=>decodeURIComponent(t).replace(/\//g,"%2F")).join("/")}catch(t){return $s(!1,'The URL path "'+e+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+t+").")),e}}function Hs(e,t){if(t==="/")return e;if(!e.toLowerCase().startsWith(t.toLowerCase()))return null;let n=t.endsWith("/")?t.length-1:t.length,r=e.charAt(n);return r&&r!=="/"?null:e.slice(n)||"/"}function x0(e,t){t===void 0&&(t="/");let{pathname:n,search:r="",hash:i=""}=typeof e=="string"?Rn(e):e;return{pathname:n?n.startsWith("/")?n:y0(n,t):t,search:j0(r),hash:C0(i)}}function y0(e,t){let n=t.replace(/\/+$/,"").split("/");return e.split("/").forEach(i=>{i===".."?n.length>1&&n.pop():i!=="."&&n.push(i)}),n.length>1?n.join("/"):"/"}function Ml(e,t,n,r){return"Cannot include a '"+e+"' character in a manually specified "+("`to."+t+"` field ["+JSON.stringify(r)+"].  Please separate it out to the ")+("`to."+n+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function w0(e){return e.filter((t,n)=>n===0||t.route.path&&t.route.path.length>0)}function sf(e,t){let n=w0(e);return t?n.map((r,i)=>i===e.length-1?r.pathname:r.pathnameBase):n.map(r=>r.pathnameBase)}function uf(e,t,n,r){r===void 0&&(r=!1);let i;typeof e=="string"?i=Rn(e):(i=ii({},e),he(!i.pathname||!i.pathname.includes("?"),Ml("?","pathname","search",i)),he(!i.pathname||!i.pathname.includes("#"),Ml("#","pathname","hash",i)),he(!i.search||!i.search.includes("#"),Ml("#","search","hash",i)));let o=e===""||i.pathname==="",l=o?"/":i.pathname,s;if(l==null)s=n;else{let p=t.length-1;if(!r&&l.startsWith("..")){let g=l.split("/");for(;g[0]==="..";)g.shift(),p-=1;i.pathname=g.join("/")}s=p>=0?t[p]:"/"}let u=x0(i,s),c=l&&l!=="/"&&l.endsWith("/"),m=(o||l===".")&&n.endsWith("/");return!u.pathname.endsWith("/")&&(c||m)&&(u.pathname+="/"),u}const sn=e=>e.join("/").replace(/\/\/+/g,"/"),S0=e=>e.replace(/\/+$/,"").replace(/^\/*/,"/"),j0=e=>!e||e==="?"?"":e.startsWith("?")?e:"?"+e,C0=e=>!e||e==="#"?"":e.startsWith("#")?e:"#"+e;function k0(e){return e!=null&&typeof e.status=="number"&&typeof e.statusText=="string"&&typeof e.internal=="boolean"&&"data"in e}const cf=["post","put","patch","delete"];new Set(cf);const E0=["get",...cf];new Set(E0);/**
 ...
 *
 * @license MIT
 */function oi(){return oi=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},oi.apply(this,arguments)}const Xs=j.createContext(null),I0=j.createContext(null),Bn=j.createContext(null),ll=j.createContext(null),zn=j.createContext({outlet:null,matches:[],isDataRoute:!1}),df=j.createContext(null);function P0(e,t){let{relative:n}=t===void 0?{}:t;pi()||he(!1);let{basename:r,navigator:i}=j.useContext(Bn),{hash:o,pathname:l,search:s}=ff(e,{relative:n}),u=l;return r!=="/"&&(u=l==="/"?r:sn([r,l])),i.createHref({pathname:u,search:s,hash:o})}function pi(){return j.useContext(ll)!=null}function fr(){return pi()||he(!1),j.useContext(ll).location}function pf(e){j.useContext(Bn).static||j.useLayoutEffect(e)}function N0(){let{isDataRoute:e}=j.useContext(zn);return e?V0():R0()}function R0(){pi()||he(!1);let e=j.useContext(Xs),{basename:t,future:n,navigator:r}=j.useContext(Bn),{matches:i}=j.useContext(zn),{pathname:o}=fr(),l=JSON.stringify(sf(i,n.v7_relativeSplatPath)),s=j.useRef(!1);return pf(()=>{s.current=!0}),j.useCallback(function(c,m){if(m===void 0&&(m={}),!s.current)return;if(typeof c=="number"){r.go(c);return}let p=uf(c,JSON.parse(l),o,m.relative==="path");e==null&&t!=="/"&&(p.pathname=p.pathname==="/"?t:sn([t,p.pathname])),(m.replace?r.replace:r.push)(p,m.state,m)},[t,r,l,o,e])}function ff(e,t){let{relative:n}=t===void 0?{}:t,{future:r}=j.useContext(Bn),{matches:i}=j.useContext(zn),{pathname:o}=fr(),l=JSON.stringify(sf(i,r.v7_relativeSplatPath));return j.useMemo(()=>uf(e,JSON.parse(l),o,n==="path"),[e,l,o,n])}function B0(e,t){return z0(e,t)}function z0(e,t,n,r){pi()||he(!1);let{navigator:i}=j.useContext(Bn),{matches:o}=j.useContext(zn),l=o[o.length-1],s=l?l.params:{};l&&l.pathname;let u=l?l.pathnameBase:"/";l&&l.route;let c=fr(),m;if(t){var p;let C=typeof t=="string"?Rn(t):t;u==="/"||(p=C.pathname)!=null&&p.startsWith(u)||he(!1),m=C}else m=c;let g=m.pathname||"/",S=g;if(u!=="/"){let C=u.replace(/^\//,"").split("/");S="/"+g.replace(/^\//,"").split("/").slice(C.length).join("/")}let w=o0(e,{pathname:S}),v=M0(w&&w.map(C=>Object.assign({},C,{params:Object.assign({},s,C.params),pathname:sn([u,i.encodeLocation?i.encodeLocation(C.pathname).pathname:C.pathname]),pathnameBase:C.pathnameBase==="/"?u:sn([u,i.encodeLocation?i.encodeLocation(C.pathnameBase).pathname:C.pathnameBase])})),o,n,r);return t&&v?j.createElement(ll.Provider,{value:{location:oi({pathname:"/",search:"",hash:"",state:null,key:"default"},m),navigationType:Zt.Pop}},v):v}function T0(){let e=G0(),t=k0(e)?e.status+" "+e.statusText:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,i={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"},o=null;return j.createElement(j.Fragment,null,j.createElement("h2",null,"Unexpected Application Error!"),j.createElement("h3",{style:{fontStyle:"italic"}},t),n?j.createElement("pre",{style:i},n):null,o)}const b0=j.createElement(T0,null);class O0 extends j.Component{constructor(t){super(t),this.state={location:t.location,revalidation:t.revalidation,error:t.error}}static getDerivedStateFromError(t){return{error:t}}static getDerivedStateFromProps(t,n){return n.location!==t.location||n.revalidation!=="idle"&&t.revalidation==="idle"?{error:t.error,location:t.location,revalidation:t.revalidation}:{error:t.error!==void 0?t.error:n.error,location:n.location,revalidation:t.revalidation||n.revalidation}}componentDidCatch(t,n){console.error("React Router caught the following error during render",t,n)}render(){return this.state.error!==void 0?j.createElement(zn.Provider,{value:this.props.routeContext},j.createElement(df.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function L0(e){let{routeContext:t,match:n,children:r}=e,i=j.useContext(Xs);return i&&i.static&&i.staticContext&&(n.route.errorElement||n.route.ErrorBoundary)&&(i.staticContext._deepestRenderedBoundaryId=n.route.id),j.createElement(zn.Provider,{value:t},r)}function M0(e,t,n,r){var i;if(t===void 0&&(t=[]),n===void 0&&(n=null),r===void 0&&(r=null),e==null){var o;if((o=n)!=null&&o.errors)e=n.matches;else return null}let l=e,s=(i=n)==null?void 0:i.errors;if(s!=null){let m=l.findIndex(p=>p.route.id&&(s==null?void 0:s[p.route.id])!==void 0);m>=0||he(!1),l=l.slice(0,Math.min(l.length,m+1))}let u=!1,c=-1;if(n&&r&&r.v7_partialHydration)for(let m=0;m<l.length;m++){let p=l[m];if((p.route.HydrateFallback||p.route.hydrateFallbackElement)&&(c=m),p.route.id){let{loaderData:g,errors:S}=n,w=p.route.loader&&g[p.route.id]===void 0&&(!S||S[p.route.id]===void 0);if(p.route.lazy||w){u=!0,c>=0?l=l.slice(0,c+1):l=[l[0]];break}}}return l.reduceRight((m,p,g)=>{let S,w=!1,v=null,C=null;n&&(S=s&&p.route.id?s[p.route.id]:void 0,v=p.route.errorElement||b0,u&&(c<0&&g===0?(U0("route-fallback",!1),w=!0,C=null):c===g&&(w=!0,C=p.route.hydrateFallbackElement||null)));let f=t.concat(l.slice(0,g+1)),d=()=>{let h;return S?h=v:w?h=C:p.route.Component?h=j.createElement(p.route.Component,null):p.route.element?h=p.route.element:h=m,j.createElement(L0,{match:p,routeContext:{outlet:m,matches:f,isDataRoute:n!=null},children:h})};return n&&(p.route.ErrorBoundary||p.route.errorElement||g===0)?j.createElement(O0,{location:n.location,revalidation:n.revalidation,component:v,error:S,children:d(),routeContext:{outlet:null,matches:f,isDataRoute:!0}}):d()},null)}var hf=function(e){return e.UseBlocker="useBlocker",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e}(hf||{}),wo=function(e){return e.UseBlocker="useBlocker",e.UseLoaderData="useLoaderData",e.UseActionData="useActionData",e.UseRouteError="useRouteError",e.UseNavigation="useNavigation",e.UseRouteLoaderData="useRouteLoaderData",e.UseMatches="useMatches",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e.UseRouteId="useRouteId",e}(wo||{});function F0(e){let t=j.useContext(Xs);return t||he(!1),t}function W0(e){let t=j.useContext(I0);return t||he(!1),t}function D0(e){let t=j.useContext(zn);return t||he(!1),t}function mf(e){let t=D0(),n=t.matches[t.matches.length-1];return n.route.id||he(!1),n.route.id}function G0(){var e;let t=j.useContext(df),n=W0(wo.UseRouteError),r=mf(wo.UseRouteError);return t!==void 0?t:(e=n.errors)==null?void 0:e[r]}function V0(){let{router:e}=F0(hf.UseNavigateStable),t=mf(wo.UseNavigateStable),n=j.useRef(!1);return pf(()=>{n.current=!0}),j.useCallback(function(i,o){o===void 0&&(o={}),n.current&&(typeof i=="number"?e.navigate(i):e.navigate(i,oi({fromRouteId:t},o)))},[e,t])}const xc={};function U0(e,t,n){!t&&!xc[e]&&(xc[e]=!0)}function On(e){he(!1)}function Q0(e){let{basename:t="/",children:n=null,location:r,navigationType:i=Zt.Pop,navigator:o,static:l=!1,future:s}=e;pi()&&he(!1);let u=t.replace(/^\/*/,"/"),c=j.useMemo(()=>({basename:u,navigator:o,static:l,future:oi({v7_relativeSplatPath:!1},s)}),[u,s,o,l]);typeof r=="string"&&(r=Rn(r));let{pathname:m="/",search:p="",hash:g="",state:S=null,key:w="default"}=r,v=j.useMemo(()=>{let C=Hs(m,u);return C==null?null:{location:{pathname:C,search:p,hash:g,state:S,key:w},navigationType:i}},[u,m,p,g,S,w,i]);return v==null?null:j.createElement(Bn.Provider,{value:c},j.createElement(ll.Provider,{children:n,value:v}))}function Y0(e){let{children:t,location:n}=e;return B0(Wa(t),n)}new Promise(()=>{});function Wa(e,t){t===void 0&&(t=[]);let n=[];return j.Children.forEach(e,(r,i)=>{if(!j.isValidElement(r))return;let o=[...t,i];if(r.type===j.Fragment){n.push.apply(n,Wa(r.props.children,o));return}r.type!==On&&he(!1),!r.props.index||!r.props.children||he(!1);let l={id:r.props.id||o.join("-"),caseSensitive:r.props.caseSensitive,element:r.props.element,Component:r.props.Component,index:r.props.index,path:r.props.path,loader:r.props.loader,action:r.props.action,errorElement:r.props.errorElement,ErrorBoundary:r.props.ErrorBoundary,hasErrorBoundary:r.props.ErrorBoundary!=null||r.props.errorElement!=null,shouldRevalidate:r.props.shouldRevalidate,handle:r.props.handle,lazy:r.props.lazy};r.props.children&&(l.children=Wa(r.props.children,o)),n.push(l)}),n}/**
 ...
 *
 * @license MIT
 */function Da(){return Da=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Da.apply(this,arguments)}function $0(e,t){if(e==null)return{};var n={},r=Object.keys(e),i,o;for(o=0;o<r.length;o++)i=r[o],!(t.indexOf(i)>=0)&&(n[i]=e[i]);return n}function H0(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function X0(e,t){return e.button===0&&(!t||t==="_self")&&!H0(e)}const _0=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","unstable_viewTransition"],K0="6";try{window.__reactRouterVersion=K0}catch{}const Z0="startTransition",yc=Uf[Z0];function q0(e){let{basename:t,children:n,future:r,window:i}=e,o=j.useRef();o.current==null&&(o.current=n0({window:i,v5Compat:!0}));let l=o.current,[s,u]=j.useState({action:l.action,location:l.location}),{v7_startTransition:c}=r||{},m=j.useCallback(p=>{c&&yc?yc(()=>u(p)):u(p)},[u,c]);return j.useLayoutEffect(()=>l.listen(m),[l,m]),j.createElement(Q0,{basename:t,children:n,location:s.location,navigationType:s.action,navigator:l,future:r})}const J0=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",eg=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,hr=j.forwardRef(function(t,n){let{onClick:r,relative:i,reloadDocument:o,replace:l,state:s,target:u,to:c,preventScrollReset:m,unstable_viewTransition:p}=t,g=$0(t,_0),{basename:S}=j.useContext(Bn),w,v=!1;if(typeof c=="string"&&eg.test(c)&&(w=c,J0))try{let h=new URL(window.location.href),y=c.startsWith("//")?new URL(h.protocol+c):new URL(c),k=Hs(y.pathname,S);y.origin===h.origin&&k!=null?c=k+y.search+y.hash:v=!0}catch{}let C=P0(c,{relative:i}),f=tg(c,{replace:l,state:s,target:u,preventScrollReset:m,relative:i,unstable_viewTransition:p});function d(h){r&&r(h),h.defaultPrevented||f(h)}return j.createElement("a",Da({},g,{href:w||C,onClick:v||o?r:d,ref:n,target:u}))});var wc;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher",e.useViewTransitionState="useViewTransitionState"})(wc||(wc={}));var Sc;(function(e){e.UseFetcher="useFetcher",e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(Sc||(Sc={}));function tg(e,t){let{target:n,replace:r,state:i,preventScrollReset:o,relative:l,unstable_viewTransition:s}=t===void 0?{}:t,u=N0(),c=fr(),m=ff(e,{relative:l});return j.useCallback(p=>{if(X0(p,n)){p.preventDefault();let g=r!==void 0?r:yo(c)===yo(m);u(e,{replace:g,state:i,preventScrollReset:o,relative:l,unstable_viewTransition:s})}},[c,u,m,r,i,n,e,o,l,s])}const Ga="/portfolio/assets/paulEvansCreativeLogo-77817caa.avif",ng=A.nav`
  position: fixed;
  grid-area: top;
  width: 100%;
  max-width: 100%;
...
`,pg=({footerRef:e})=>{const t=fr(),[n,r]=j.useState(!1),[i,o]=j.useState(t.pathname),[l,s]=j.useState(!1),[u,c]=j.useState(window.pageYOffset),[m,p]=j.useState(!0);j.useEffect(()=>{o(t.pathname);const v=()=>{const C=window.pageYOffset;p(u>C||C<10),c(C)};return window.addEventListener("scroll",v),()=>window.removeEventListener("scroll",v)},[t.pathname,u]);const g=()=>{e.current&&e.current.scrollIntoView({behavior:"smooth"}),r(!1),s(!1)},S=()=>{r(!1),s(!1)},w=[{id:1,to:"/",text:"Home"},{id:2,to:"/casestudies",text:"Case Studies"},{id:3,to:"https://www.paulevans-dop.com/",text:"Cinematography",isExternal:!0},{id:4,to:"/about",text:"About"},{id:5,to:"#",text:"Contact",onClick:g}];return a.jsxs(ng,{visible:m,children:[a.jsx(rg,{children:a.jsx(hr,{to:"/",onClick:S,children:a.jsx(ag,{children:a.jsx(og,{src:Ga,alt:"the letters P and E merged together to form the logo Paul Evans Creative"})})})}),a.jsxs(sg,{open:n,children:[w.map(v=>v.isExternal?a.jsx(cg,{href:v.to,onClick:v.onClick||S,className:i===v.to?"active":"",children:v.text},v.id):a.jsx(ug,{to:v.to,onClick:v.onClick||S,className:i===v.to?"active":"",children:v.text},v.id)),a.jsx(ig,{children:a.jsx(lg,{src:Ga,alt:"the letters P and E merged together to form the logo Paul Evans Creative"})})]}),a.jsx(dg,{children:a.jsx("div",{onClick:()=>{r(!n),s(!l)},children:a.jsx(t0,{toggled:l})})})]})},fg="/portfolio/assets/smoke-56940dcc.gif",hg=e=>{const t=new Image;t.src=e},mg=Gt`
  0% {
...
`,vg=A.div`
  animation: ${mg} 1s ease-out 0.5s forwards;
`,xg=A.p`
  width: 70%;
  font-size: 24px;
...
`,Mg=({onClick:e})=>a.jsxs(bg,{children:[a.jsx(Og,{children:a.jsx("a",{href:"https://paulevans-dop.com/",target:"_blank",rel:"noopener noreferrer",children:a.jsx(mn,{onClick:e,size:70})})}),a.jsx(Lg,{children:"See Cinematography Reel"})]}),Fg=A.div`
  position: relative;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`,Ug=A.div`
  margin-top: auto;
`;function Qg(e){const t=j.useRef(null);j.useEffect(()=>{const i=()=>{window.innerWidth<=960?t.current&&t.current.play():t.current&&(t.current.pause(),t.current.currentTime=0,t.current.style.visibility="hidden")};return window.addEventListener("resize",i),i(),()=>{window.removeEventListener("resize",i)}},[]);const n=()=>{window.innerWidth>960&&t.current&&(t.current.play(),t.current.style.visibility="visible")},r=()=>{window.innerWidth>960&&t.current&&(t.current.pause(),t.current.currentTime=0,t.current.style.visibility="hidden")};return a.jsxs(Fg,{onMouseEnter:n,onMouseLeave:r,children:[a.jsx(Wg,{className:"cinema-video",ref:t,src:wg,loop:!0,muted:!0,playsInline:!0,preload:"auto",alt:"A showreel showing clips from different productions."}),a.jsx(Dg,{className:"poster-image",src:Sg,alt:"Poster Image"}),a.jsx(Gg,{children:a.jsxs(Vg,{children:[a.jsx("h3",{children:"Cinematographer"}),a.jsx("p",{children:"Member of fsf Föreningen Severiges Filmfotografer (The Association of Swedish Film Cinematographers). Working in Narrative, Commercials, Music Videos and Still Photography."}),a.jsx(Ug,{children:a.jsx(Mg,{})})]})})]})}const Yg="/portfolio/assets/conceptReel-4e8f05ad.mp4",$g="/portfolio/assets/conceptPosterImg-a9498170.avif",Hg=A.div`
  position: relative;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`;function tv(e){const t=j.useRef(null);j.useEffect(()=>{const i=()=>{window.innerWidth<=960?t.current&&t.current.play():t.current&&(t.current.pause(),t.current.currentTime=0,t.current.style.visibility="hidden")};return window.addEventListener("resize",i),i(),()=>{window.removeEventListener("resize",i)}},[]);const n=()=>{window.innerWidth>960&&t.current&&(t.current.play(),t.current.style.visibility="visible")},r=()=>{window.innerWidth>960&&t.current&&(t.current.pause(),t.current.currentTime=0,t.current.style.visibility="hidden")};return a.jsxs(Hg,{onMouseEnter:n,onMouseLeave:r,children:[a.jsx(Xg,{className:"concept-video",ref:t,src:Yg,loop:!0,muted:!0,playsInline:!0,preload:"auto",alt:"A video showing animated AI images made for TV concepts."}),a.jsx(_g,{className:"poster-image",src:$g,alt:"Poster Image"}),a.jsx(Kg,{children:a.jsxs(Zg,{children:[a.jsx("h3",{children:"Writer"}),a.jsx("p",{children:"As a writer and concept developer, I have been commissioned to write concepts based on briefs provided by TV channels and streaming services and had concepts optioned."}),a.jsxs(qg,{children:[a.jsx(Jg,{children:"Want to know more? Send me an email."}),a.jsx(ev,{href:"mailto:paul.evans.creative@gmail.com",children:"paul.evans.creative@gmail.com"})]})]})})]})}const Cc="/portfolio/assets/uxuiReel-e01a0e6b.mp4",nv=A.div`
  width: 200px;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`,F1=({onClick:e})=>a.jsxs(O1,{children:[a.jsx(L1,{children:a.jsx(hr,{to:"/ebie",children:a.jsx(mn,{onClick:e,size:70})})}),a.jsx(M1,{children:"See Case Study"})]}),W1=Gt`
  0% {
    transform: translateX(100%);
    opacity: 0;
  }
...
`,$1=A.img`
  ...
  ${({isInView:e})=>e&&hn`
      animation: ${W1} 1s ease-out forwards;
    `}
...
`,ax=()=>{const[e,t]=Fl(),[n,r]=Fl(),[i,o]=Fl(),l=j.useRef(null),s=()=>{l.current&&l.current.scrollIntoView({behavior:"smooth"})};return a.jsxs(lx,{children:[a.jsx(yg,{}),a.jsxs(Ic,{ref:e,isVisible:t,children:[a.jsx(pv,{}),a.jsx(Bv,{})]}),a.jsx(e1,{scrollToEvent:s}),a.jsxs(Ic,{ref:n,isVisible:r,children:[a.jsx(Qg,{}),a.jsx(tv,{})]}),a.jsx("div",{ref:l}),a.jsx(Sf,{}),a.jsx(b1,{}),a.jsx(kf,{}),a.jsx(ox,{ref:i,isVisible:o,children:a.jsx(ix,{})})]})},sx=A.section`
  max-width: 100vw;
  min-width: 100vw;
  display: flex;
  flex-direction: column;
...
`,jx=()=>{const e=j.useRef(null),[t,n]=j.useState(!1);return j.useEffect(()=>{const r=new IntersectionObserver(i=>{i[0].isIntersecting&&n(!0)},{threshold:.1});return e.current&&r.observe(e.current),()=>{e.current&&r.unobserve(e.current)}},[]),a.jsxs(xx,{children:[a.jsxs(yx,{children:[a.jsx("h3",{children:"For fun"}),a.jsx("p",{children:"Surfing and traveling are my two biggest passions. When I'm not paddling out into the sea I like to work out at the gym or swim in the lake. I also cherish the time I spend with my family, friends cooking and watching movies and TV shows."})]}),a.jsx(wx,{children:a.jsx(Sx,{ref:e,src:gx,alt:"A surfboard propped up against a mobile home",isInView:t})})]})},Cx=A.section`
  ...
  align-content: center;
  margin-top: 170px;
`,kx=()=>(j.useRef(null),a.jsxs(Cx,{children:[a.jsx(Ax,{}),a.jsx(jx,{})]})),Ex="/portfolio/assets/challenges-70c5b3a7.avif",Ix="/portfolio/assets/fans-667fbfce.avif",Px="/portfolio/assets/research-b4a1f59e.avif",Nx="/portfolio/assets/mapping-c6580bd3.avif",Rx="/portfolio/assets/lipus-00a0d7ff.avif",Bx="/portfolio/assets/physio-5d7e362e.avif",zx="/portfolio/assets/athlete-40b4363a.avif",Tx="/portfolio/assets/insights-cb84265a.avif",bx="/portfolio/assets/webinar-966c915f.avif",Ox="/portfolio/assets/webinarMobile-18a4ce2a.avif",Lx="/portfolio/assets/designOne-24f39a91.avif",Mx="/portfolio/assets/designTwo-b7e3107e.avif",Fx="/portfolio/assets/webflow-baa33610.avif",Wx="/portfolio/assets/reflection-72e94f6a.avif",Dx=A.div`
  width: 400px;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`,Ux=({onClick:e})=>a.jsxs(Dx,{children:[a.jsx(Gx,{children:a.jsx("a",{href:"https://www.lipusplus.com/casestudies/hammarby",target:"_blank",rel:"noopener noreferrer",children:a.jsx(mn,{onClick:e,size:70})})}),a.jsx(Vx,{children:"See live page at LipusPlus.com"})]}),Qx=A.section`
  max-width: 100vw;
  min-width: 100vw;
  display: flex;
  flex-direction: column;
...
`,Fy=()=>{const[e,t]=j.useState(!1),n=()=>{const i=document.documentElement.scrollTop;i>1200?t(!0):i<=1200&&t(!1)},r=()=>{window.scrollTo({top:0,behavior:"smooth"})};return window.addEventListener("scroll",n),a.jsx(Ly,{children:a.jsx(My,{children:a.jsx(Tg,{onClick:r,style:{display:e?"inline":"none",borderRadius:"50%"}})})})},Wy=[{id:1,href:"https://www.linkedin.com/in/paul-evans-3a74605/",icon:a.jsx(zg,{}),des:"LinkedIn"},{id:2,href:"https://www.instagram.com/paulevanscreative/",icon:a.jsx(Bg,{}),des:"Instagram"},{id:3,href:"https://www.imdb.com/name/nm3171341/?ref_=ttfc_fc_cr",icon:a.jsx(Rg,{}),des:"Imdb"}],Dy=A.footer`
  background-color: var(--main-hero-backgroundcolor);
  max-width: 100vw;
  min-width: 100vw;
  z-index: 98;
...
`,Jy=A.div`
  ...
  justify-items: center;
  justify-content: space-evenly;
`,ew=()=>{const e=j.useRef(null);return a.jsxs(q0,{children:[a.jsx(Zy,{}),a.jsxs(qy,{children:[a.jsx(pg,{footerRef:e}),a.jsxs(Jy,{children:[a.jsxs(Y0,{children:[a.jsx(On,{path:"/",element:a.jsx(ax,{})}),a.jsx(On,{path:"/casestudies",element:a.jsx(ux,{})}),a.jsx(On,{path:"/about",element:a.jsx(kx,{})}),a.jsx(On,{path:"/lipusplus",element:a.jsx(sy,{})}),a.jsx(On,{path:"/ebie",element:a.jsx(Oy,{})})]}),a.jsx(_y,{ref:e})]}),a.jsx(Fy,{})]})]})};Wl.createRoot(document.getElementById("root")).render(a.jsx(ge.StrictMode,{children:a.jsx(ew,{})}));
