...
`,rg=({footerRef:e})=>{const t=Jn(),[n,r]=E.useState(!1),[i,o]=E.useState(t.pathname),[l,a]=E.useState(!1),[s,u]=E.useState(window.pageYOffset),[h,m]=E.useState(!0);E.useEffect(()=>{o(t.pathname);const v=()=>{const C=window.pageYOffset;m(s>C||C<10),u(C)};return window.addEventListener("scroll",v),()=>window.removeEventListener("scroll",v)},[t.pathname,s]);const g=()=>{e.current&&e.current.scrollIntoView({behavior:"smooth"}),r(!1),a(!1)},k=()=>{r(!1),a(!1)},w=[{id:1,to:"/",text:"Home"},{id:2,to:"https://www.paulevans-dop.com/",text:"Cinematography",isExternal:!0},{id:3,to:"/about",text:"About"},{id:4,to:"#",text:"Contact",onClick:g}];return f.jsxs(G1,{visible:h,children:[f.jsx(K1,{children:f.jsx(Xs,{to:"/",onClick:k,children:f.jsx(J1,{children:f.jsx(b1,{src:Ua,alt:"A revolving logo showing the initals PE and a cartton version of Paul Evans.."})})})}),f.jsxs(q1,{open:n,children:[w.map(v=>v.isExternal?f.jsx(tg,{href:v.to,onClick:v.onClick||k,className:i===v.to?"active":"",children:v.text},v.id):f.jsx(eg,{to:v.to,onClick:v.onClick||k,className:i===v.to?"active":"",children:v.text},v.id)),f.jsx(X1,{children:f.jsx(Z1,{src:Ua,autoPlay:!0,loop:!0,muted:!0,playsInline:!0,alt:"A revolving logo showing the initals PE and a cartton version of Paul Evans.."})})]}),f.jsx(ng,{children:f.jsx("div",{onClick:()=>{r(!n),a(!l)},children:f.jsx(Y0,{toggled:l})})})]})},ig="/portfolio/assets/showcase1-4574d875.mp4",og=S.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  width: 100%;
...
`,ty=()=>{const e=E.useRef(null);return f.jsxs(ey,{children:[f.jsx(Og,{}),f.jsx(wn,{}),f.jsx(qv,{cinemaCardRef:e}),f.jsx(wn,{}),f.jsx(gg,{ref:e}),f.jsx(wn,{}),f.jsx(Lv,{}),f.jsx(wn,{}),f.jsx(Xg,{}),f.jsx(wn,{}),f.jsx(Kv,{}),f.jsx(wn,{})]})},ny="/portfolio/assets/meAbout-b0dd0af4.avif",ry=Qs`
  0% {
...
`,zy=()=>{const[e,t]=E.useState(!1),n=()=>{const i=document.documentElement.scrollTop;i>1200?t(!0):i<=1200&&t(!1)},r=()=>{window.scrollTo({top:0,behavior:"smooth"})};return window.addEventListener("scroll",n),f.jsx($y,{children:f.jsx(Iy,{children:f.jsx(_y,{onClick:r,style:{display:e?"inline":"none",borderRadius:"50%"}})})})},Ry=[{id:1,href:"https://github.com/PaulEvans78",icon:f.jsx(Cy,{}),des:"Github",target:"_blank",rel:"noopener noreferrer"},{id:2,href:"https://www.linkedin.com/in/paul-evans-3a74605/",icon:f.jsx(Py,{}),des:"LinkedIn",target:"_blank",rel:"noopener noreferrer"},{id:3,href:"https://www.instagram.com/paulevans_official/",icon:f.jsx(jy,{}),des:"Instagram",target:"_blank",rel:"noopener noreferrer"},{id:4,href:"https://www.imdb.com/name/nm3171341/?ref_=ttfc_fc_cr",icon:f.jsx(Ey,{}),des:"Imdb",target:"_blank",rel:"noopener noreferrer"}],Ty=S.footer`
  background-color: var(--main-hero-backgroundcolor);
  max-width: 100vw;
  min-width: 100vw;
  z-index: 98;
...
`,By=pe.forwardRef((e,t)=>f.jsxs(Ty,{ref:t,children:[f.jsx(Dy,{children:f.jsx(Xs,{to:"/",children:f.jsx(Uy,{src:Ua,autoPlay:!0,loop:!0,muted:!0,playsInline:!0,alt:"A revolving logo showing the initals PE and a cartton version of Paul Evans.."})})}),f.jsx(Vy,{}),f.jsxs(Ny,{children:[f.jsx($c,{children:"Copyright 2024."}),f.jsx($c,{children:"Paul Evans."}),f.jsx(Ly,{children:f.jsx("a",{href:"mailto:paul@paulevans.se",children:"paul@paulevans.se"})}),f.jsx(Oy,{children:f.jsx("a",{href:"tel:+46739908858",children:"+46739908858"})})]})]})),Vy=()=>f.jsx(Ay,{children:f.jsx(Ba.Provider,{value:{size:"2em"},children:Ry.map(e=>f.jsxs(My,{href:e.href,target:e.target,rel:e.rel,children:[e.icon,f.jsx(Fy,{children:e.des})]},e.id))})}),Wy=()=>{const{pathname:e}=Jn();return E.useEffect(()=>{window.scrollTo(0,0)},[e]),null},Hy=S.div`
  min-height: 100%;
  max-width: 100vw;
`,Qy=S.div`
  max-width: 100vw;
  ...
  justify-items: center;
  justify-content: space-evenly;
`,Yy=()=>{const e=E.useRef(null);return f.jsxs(W1,{children:[f.jsx(Wy,{}),f.jsxs(Hy,{children:[f.jsx(rg,{footerRef:e}),f.jsxs(Qy,{children:[f.jsxs(A1,{children:[f.jsx(Ma,{path:"/",element:f.jsx(ty,{})}),f.jsx(Ma,{path:"/about",element:f.jsx(ky,{})})]}),f.jsx(By,{ref:e})]}),f.jsx(zy,{})]})]})};Ml.createRoot(document.getElementById("root")).render(f.jsx(pe.StrictMode,{children:f.jsx(Yy,{})}));
