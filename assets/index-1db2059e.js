...
`,Py=ve.forwardRef((e,t)=>m.jsxs(vy,{ref:t,children:[m.jsx(Ey,{children:m.jsx(Xs,{to:"/",children:m.jsx(jy,{src:Ua,autoPlay:!0,loop:!0,muted:!0,playsInline:!0,alt:"A revolving logo showing the initals PE and a cartton version of Paul Evans.."})})}),m.jsx(_y,{}),m.jsxs(yy,{children:[m.jsx($c,{children:"Copyright 2024."}),m.jsx($c,{children:"Paul Evans."}),m.jsx(xy,{children:m.jsx("a",{href:"mailto:paul@paulevans.se",children:"paul@paulevans.se"})}),m.jsx(wy,{children:m.jsx("a",{href:"tel:+46739908858",children:"+46739908858"})})]})]})),_y=()=>m.jsx(Sy,{children:m.jsx(Ba.Provider,{value:{size:"2em"},children:gy.map(e=>m.jsxs(ky,{href:e.href,target:e.target,rel:e.rel,children:[e.icon,m.jsx(Cy,{children:e.des})]},e.id))})}),$y=()=>{const{pathname:e}=qn();return E.useEffect(()=>{window.scrollTo(0,0)},[e]),null},Iy=S.div`
  min-height: 100%;
  max-width: 100vw;
`,zy=S.div`
  max-width: 100vw;
