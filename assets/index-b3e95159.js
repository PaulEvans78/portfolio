...
`,Qv=({scrollToEvent:e})=>{const t=C.useRef(null),n=C.useRef(null),[r,i]=C.useState(!1),[o,l]=C.useState(!1),[s,u]=C.useState(!1);C.useEffect(()=>{const f=()=>{l(window.innerWidth<1024)};return f(),window.addEventListener("resize",f),()=>window.removeEventListener("resize",f)},[]),C.useEffect(()=>{const f=setTimeout(()=>{t.current&&t.current.play()},1e3);return()=>clearTimeout(f)},[]),C.useEffect(()=>{const f=()=>{i(!1),n.current&&(n.current.pause(),n.current.currentTime=0)};return n.current&&(n.current.addEventListener("pause",f),n.current.addEventListener("ended",f)),()=>{n.current&&(n.current.removeEventListener("pause",f),n.current.removeEventListener("ended",f))}},[o]);const c=()=>{if(o){if(n.current){u(!0);const f=n.current;f.pause(),f.currentTime=0;const g=f.play();g!==void 0&&g.then(()=>{f.requestFullscreen().catch(S=>{console.log("Error attempting to enable full-screen mode:",S)})}).catch(S=>{console.log("Failed to play the video automatically:",S)})}}else i(!0)},m=()=>{i(!1),t.current&&(t.current.pause(),t.current.currentTime=0)};return a.jsxs(Fv,{children:[a.jsx(Mv,{ref:t,src:jc,loop:!0,muted:!0,playsInline:!0,alt:"Background video"}),a.jsx(Dv,{}),a.jsxs(Wv,{children:[a.jsx(Gv,{children:a.jsx(Vv,{src:Rv,alt:"LipusPlus logo"})}),a.jsx("h4",{children:"Meet the Physio of Hammarby Handball"}),a.jsx("p",{children:"Brand film highlighting LipusPlus's partnership with Hammarby Handball, showcasing through testimonals the effectiveness of the modality."}),a.jsxs(Uv,{children:[a.jsx(Ev,{onClick:c}),a.jsx(Bv,{onClick:e})]})]}),a.jsx(bv,{isOpen:r,onClose:m,children:a.jsx("video",{controls:!0,autoPlay:!0,children:a.jsx("source",{src:jc,type:"video/mp4"})})}),s&&a.jsx("video",{ref:n,style:{display:"none"},src:Sv,type:"video/mp4",controls:!0})]})},gf="/portfolio/assets/lipusPlusLogo-022851c3.avif",vf="/portfolio/assets/lipusHeroImg-44921e74.avif",Yv=A.div`
  width: 200px;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
