...
`;function H2(e){return b(j2,{children:[y(M2,{src:e.mainPic,alt:"Category Image"}),b(F2,{children:[y(U2,{children:e.headline}),y(B2,{children:e.description}),y("a",{href:e.buttonLink,children:y(b2,{children:e.buttonText})})]})]})}const W2=()=>{const[e,t]=pe.useState([]);return pe.useEffect(()=>{(async()=>{const r=await jn("skills.json");t(r.data.landingpage)})()},[]),y(Yt,{children:e.map(n=>y(H2,{...n}))})},V2=k.div`
  grid-area: main;
  max-width: 100vw; 
  display: flex;
  flex-direction: row;
...
`;function ph(e){return b(Dw,{children:[y(jw,{src:e.mainPic,alt:"Background"}),b(Mw,{children:[y(Fw,{children:e.headline}),y(Uw,{children:e.description})]})]})}const Bw=()=>{const[e,t]=pe.useState([]);return pe.useEffect(()=>{(async()=>{const r=await jn("skills.json");t(r.data.casetopcards)})()},[]),y(Yt,{children:e.map(n=>y(ph,{...n}))})},bw=k.div`
...
`;function Ww(e){return y(bw,{children:y(Hw,{src:e.mainPic,alt:"Spotify"})})}const Vw=()=>{const[e,t]=pe.useState([]);return pe.useEffect(()=>{(async()=>{const r=await jn("skills.json");t(r.data.casespotify)})()},[]),y(Yt,{children:e.map(n=>y(Ww,{...n}))})},Qw=k.div`
...
`;function Xw(e){return y(Qw,{children:b(Kw,{children:[y(Gw,{children:e.headline}),y(Yw,{children:e.description})]})})}const mh=()=>y(Yt,{children:[{headline:"1",description:"Research"},{headline:"2",description:"Personas"},{headline:"3",description:"Wireframing"},{headline:"4",description:"Prototyping"},{headline:"5",description:"User & A/B test"}].map(t=>y(Xw,{...t}))}),Jw="/assets/spotifyprototype1-e67544bc.png",qw="/assets/spotifyprototype2-9d4648d8.png",Zw="/assets/spotifyprototype3-720028f9.png",ex="/assets/ezgif.com-video-to-gif-56eba41b.gif",bn=k.h5`
...
`;function $x(e){return y(Ox,{children:y(Ax,{src:e.mainPic,alt:"Spotify"})})}const Nx=()=>{const[e,t]=pe.useState([]);return pe.useEffect(()=>{(async()=>{const r=await jn("skills.json");t(r.data.casecookwise)})()},[]),y(Yt,{children:e.map(n=>y($x,{...n}))})},zx="/assets/colors-754b24c7.png",Lx="/assets/CWfonts-1aefa1c5.png",Ix="/assets/signup-81bf0a63.png",Dx="/assets/safety-30f4d397.png",jx="/assets/CookWise-9b0207e2.gif",Hn=k.h5`
    margin: 1em 0em 2em 2em;
    white-space: pre-wrap;
    flex-wrap: wrap;
    text-align: center;
